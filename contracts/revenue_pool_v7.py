...
def approval_program():
    ...
    # Capped at 7 inner txns to stay within AVM limits (same as V6 max).
    # ----------------------------------------------------------------
    ...
    on_claim_revenue_all = Seq(
        ...
        While(
            And(
                ...
                cra_paid_rnds.load() < Int(7),   # AVM inner-txn cap
            )
        ).Do(
...
if __name__ == "__main__":
    raise RuntimeError(
        "Do not compile directly. Use deploy_v7.py with the Algorand Python SDK."
    )