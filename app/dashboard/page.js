...
import { 
  ...
  TrendingUp, Layout, Cpu, LineChart, Terminal, Box, ArrowRight, Sparkles, ShieldCheck
} from 'lucide-react';
      ...
      <Tabs defaultValue="overview" className="w-full">
        <div className="relative w-full">
          <TabsList className="bg-slate-900/50 border border-white/5 p-1 h-12 rounded-2xl mb-8 overflow-x-auto flex-nowrap max-w-full custom-scrollbar">
            <TabsTrigger value="overview" className="rounded-xl px-8 data-[state=active]:bg-indigo-600 italic font-bold uppercase text-xs">Overview</TabsTrigger>
