...
const productRow = createHeldRevenueLedgerRow({
  ...
  currency: 'USD',
  grossLicenseFeeCents: 2500,
  platformFeeCents: 0,
  allocationCents: 2500,
  usdcAtomicUnits: 25000000,
  calculationVersion: 'product_revenue_no_platform_fee_v1',
  roundingPolicy: 'product_revenue_full_merchandise_allocation_v1',
