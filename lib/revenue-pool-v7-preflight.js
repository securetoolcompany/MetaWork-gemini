...
function createFreshnessSnapshot({
  ...
  return Object.freeze({
    ...
    adminAddress,
    ipAssetId,
    heldUsdcAtomicUnits: poolState.heldUsdcAtomicUnits.toString(),
    currentRoundId: poolState.currentRoundId.toString(),
    stakeholderCount: poolState.stakeholderCount,
    releaseStatus: releaseState?.releaseStatus || 'unknown',
    requiredMbrMicroAlgos,
    requiredFeesMicroAlgos,
    requiredTotalMicroAlgos,
  });
