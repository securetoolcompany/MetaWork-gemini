...
export const ACADEMY_ACCESS_LEVELS = [
  { id: 'public', label: 'Free' },
  { id: 'members', label: 'Members' },
  { id: 'school-partner', label: 'School / Partner' },
];
...
export const ACADEMY_VIDEOS = [
  {
    ...
    audiences: ['creators', 'students', 'educators'],
  ...
  },
  {
    ...
    audiences: ['educators', 'students', 'creators'],
    topics: ['education-programs', 'entrepreneurship'],
    format: 'case-study',
    level: 'start-here',
    accessLevel: 'public',
    sectionId: 'schools-and-programs',
    featuredRank: 5,
